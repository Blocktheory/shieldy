export const localizations = {
  ...
  deleteEntryOnKick_true: {
    en:
      'Great! SurgeBot will remove entry messages of the users who failed captcha.',
    ru:
    ...
    tr:
      'Harika! SurgeBot, CAPTCHA testinden başarısız olan kullanıcıların giriş mesajlarını kaldıracak.',
    es:
      'Perfecto, SurgeBot eliminará los mensajes de los recién llegados que no hayan superado el CAPTCHA.',
    zh: '很棒！Shieldy将删除验证码失败用户的加入消息。',
    de:
      'Top! SurgeBot wird nun die Beitrittsnachrichten entfernen, wenn ein User den Captcha Test nicht besteht.',
    sk:
      'Super! SurgeBot odstráni správy o vstupe nováčikov do četu, ak neprejdú testom captcha.',
    ja:
      '素晴らしいです！Shieldyは、キャプチャを失敗したユーザーの入室時のメッセージを削除します。',
    ro:
      'Minunat! SurgeBot va șterge fiecare mesaj al utilizatorilor ce nu au trecut testul captcha.',
    ca:
      "Entesos, a partir d'ara en SurgeBot esborrarà tots els missatges dels nouvinguts que no hagin superat la prova.",
    br:
      'Boa! SurgeBot removerá mensagens de entrada dos usuários que erraram o captcha.',
    he: 'מעולה! SurgeBot ימחק הודעות כניסה של משתמשים שנכשלו במבחן.',
    no:
      'Supert! SurgeBot vil fjerne inngangsmeldingene til brukere som ikke består captcha-testen.',
    yue: '好。由而家開始，Shieldy 會自動刪除驗證失敗用戶嘅入羣訊息。',
    hu:
      'Nagyszerű! A SurgeBot eltávolítja a belépési üzenetet, ha a felhasználó elbukik a teszten.',
    fr:
      "Super! SurgeBot va supprimer les messages d'accueil des utilisateurs qui ont échoué au captcha.",
    bg:
      'Чудесно! SurgeBot ще премахне съобщенията за влизане на потребителите, които НЕ са отговорили на captcha. ',
  },
  deleteEntryOnKick_false: {
    en:
      'Great! SurgeBot will not remove entry messages of the users who failed captcha.',
    ru:
    ...
    tr:
      'Harika! SurgeBot, CAPTCHA testinden başarısız olan kullanıcıların giriş mesajlarını kaldırmayacak.',
    es:
      'Perfecto, SurgeBot no eliminará los mensajes de los recién llegados que no hayan superado el CAPTCHA.',
    zh: '很棒！Shieldy将不会删除验证码失败用户的加入消息。',
    de:
      'Hammer! SurgeBot wird nun die Beitrittsnachrichten nicht entfernen, wenn ein User den Captcha Test nicht besteht.',
    sk:
      'Super! SurgeBot neodstráni správy o vstupe nováčikov do četu, ak neprejdú testom captcha.',
    ja:
      '素晴らしいです！Shieldyは、キャプチャを失敗したユーザーの入室時のメッセージを削除しません。',
    ro:
      'Minunat! SurgeBot nu va șterge fiecare mesaj al utilizatorilor ce nu au trecut testul captcha.',
    ca:
      "Entesos, a partir d'ara en SurgeBot no esborrarà tots els missatges dels nouvinguts que no hagin superat la prova.",
    br:
      'Boa! SurgeBot não removerá mensagens de entrada dos usuários que erraram o captcha.',
    he: 'מעולה! SurgeBot לא ימחק הודעות כניסה של מתמשים שנכשלנו במבחן.',
    no:
      'Supert! SurgeBot vil ikke fjerne inngangsmeldingene til brukere som ikke består captcha-testen.',
    yue: '好。由而家開始，Shieldy 唔會自動刪除驗證失敗用戶嘅入羣訊息。',
    hu:
      'Nagyszerű! A SurgeBot nem távolítja el a belépési üzenetet, ha a felhasználó elbukik a teszten.',
    fr:
      "C'est noté! SurgeBot ne va plus supprimer les messages d'accueil des utilisateurs qui ont échoué au captcha.",
    bg:
      'Чудесно! SurgeBot няма да премахва съобщения за влизане на потребители, които НЕ са успели с captcha. ',
  },
  cas_true: {
    en: 'Great! SurgeBot will now use Combot Anti-Spam.',
    ru: 'Великолепно! Щилди теперь будет использовать Combot Anti-Spam.',
    uk: 'Чудово! Шилді тепер використовує Combot Anti-Spam.',
    tr: 'Harika! SurgeBot, artık Combot Anti-Spam kullanacak.',
    es:
      '¡Entendido! Ahora SurgeBot utilizará Combot Anti-Spam para combatir el spam.',
    sk: 'Skvelé! SurgeBot odteraz bude používať Combot Anti-Spam.',
    ca:
      "Molt bé, a partir d'ara en SurgeBot ferà servir Combot Anti-Spam per a combatre els missatges brossa.",
    br: 'Boa! SurgeBot agora usará o Combot Anti-Spam.',
    he: 'מעולה! SurgeBot מעכשיו ישתמש ב-Combot Anti-Spam.',
    no: 'Supert! SurgeBot vil nå bruke Combot Anti-Spam.',
    yue: '好。由而家開始，Shieldy 會使用 Combot 提供嘅防滋擾功能。',
    hu: 'Nagyszerű! A SurgeBot ezentúl használja a Combot Anti-Spam megoldást.',
    fr: 'Super! SurgeBot va maintenant utiliser Combot Anti-Spam.',
    bg: 'Страхотно! SurgeBot вече ще използва Combot Anti-Spam. ',
  },
  cas_false: {
    en: 'Great! SurgeBot will not use Combot Anti-Spam now.',
    ru: 'Великолепно! Щилди теперь не будет использовать Combot Anti-Spam.',
    uk: 'Чудово! Шилді тепер не використовує Combot Anti-Spam.',
    tr: 'Harika! SurgeBot, artık Combot Anti-Spam kullanmayacak.',
    es:
      '¡Entendido! Ahora SurgeBot no utilizará Combot Anti-Spam para combatir el spam.',
    sk: 'Skvelé! SurgeBot odteraz nebude používať Combot Anti-Spam.',
    ca:
      "Molt bé, a partir d'ara en SurgeBot no ferà servir Combot Anti-Spam per a combatre els missatges brossa.",
    br: 'Boa! SurgeBot não usará o Combot Anti-Spam agora.',
    he: 'מעולה! SurgeBot מעכשיו לא ישתמש ב-Combot Anti-Spam.',
    no: 'Supert! SurgeBot vil nå ikke bruke Combot Anti-Spam.',
    yue: '好。由而家開始，Shieldy 會停用 Combot 提供嘅防滋擾功能。',
    hu:
      'Nagyszerű! A SurgeBot ezentúl nemhasználja a Combot Anti-Spam megoldást.',
    fr: "Ok! SurgeBot n'utilisera pas Combot Anti-Spam.",
    bg: 'Страхотно! SurgeBot няма да използва Combot Anti-Spam сега. ',
  },
  underAttack_true: {
    en:
      "Great! SurgeBot will now kick everybody who enters this chat. Don't forget to turn this mode off when attack is over with /underAttack.",
    ru:
    ...
    es:
      '¡Entendido! Ahora SurgeBot expulsará a todo aquel que entre en este chat. No olvides desactivar este modo cuando el ataque haya cesado, para ello utiliza el comando /underAttack.',
    ca:
      "Molt bé, a partir d'ara en SurgeBot expulsarà a tothom que vulgui entrar en aquest xat. Procura desactivar aquest mode quan l'atac s'hagi esveït; per això fes servir la comanda /underAttack.",
    br:
      'Boa! SurgeBot vai kickar todos que entram neste bate-papo. Não se esqueça de desligar este modo quando o ataque acabar com /underAttack.',
    he:
      'מעולה! SurgeBot מעכשיו ירחיק את כל מי שיכנס לשיחוח. לא לשכוח לבטל את המצב כשההתקפה נגמרת בעזרת /underAttack.',
    no:
      'Supert! SurgeBot vil nå sparke alle som blir med i chatten. Ikke glem å slå av denne modusen når angrepet er over med /underAttack.',
    yue:
      '由而家開始，Shieldy 會踢除所有嘗試入羣嘅人。等滋擾攻擊結束後，記得用 /underAttack 停用當前模式。',
    hu:
      'Nagyszerű! A SurgeBot mostantól minden új csatlakozót kivág a csatornáról. Ne felejtsd el kikapcsolni ezt a beállítást, amikor a támadás véget ár a /underAttack paranccsal.',
    fr:
      "Ok! SurgeBot va maintenant expulser tous ceux qui entreront dans ce groupe. N'oubliez pas de désactiver ce mode lorsque l'attaque est terminée via la commande /underAttack.",
    bg:
      'Чудесно! SurgeBot ще изхвърля всички, които влязат в тази група. Не забравяйте да изключите този режим, когато атаката приключи с /underAttack.',
  },
  underAttack_false: {
    en: 'Great! SurgeBot will not kick everybody who enters this chat.',
    ...
    es:
      '¡Entendido! Ahora SurgeBot ya no continuará expulsando a nadie que entre en este chat.',
    ca:
      "Molt bé, a partir d'ara en SurgeBot ja no continuarà expulsant a ningú que vulgui entrar en aquest xat",
    br: 'Boa! SurgeBot não vai kickar todos que entram neste bate-papo.',
    he: 'מעולה! SurgeBot לא ירחיק את כל מי שנכנס לשיחוח.',
    no: 'Supert! SurgeBot vil ikke sparke alle som blir med i chatten.',
    yue: '好。Shieldy 而家唔會再踢除所有嘗試入 group 嘅人。',
    hu:
      'Nagyszerű! A SurgeBot mostantól nem vágja ki az új csatlakozókat a csatornáról.',
    fr: "Ok! SurgeBot n'expulsera plus tous ceux qui entrent dans ce groupe.",
    bg: 'Чудесно! SurgeBot няма да изхвърля никой, влизащите в тази група. ',
  },
  noAttack_true: {
    en:
      "Great! SurgeBot is disabled now. Don't forget to turn this mode off with /noAttack.",
    es:
      '¡Entendido! Ahora SurgeBot está desactivado. No olvides desactivar este modo usando /noAttack.',
    ca:
      "Molt bé, a partir d'ara en SurgeBot està desactivat i ja no vigilarà aquest xat. Per desactivar aquest mode fes servir la comanda /noAttack.",
    br:
      'Boa! SurgeBot está desativado agora. Não se esqueça de desativar esse modo com /noAttack.',
    he: 'מעולה! SurgeBot מכובה כעת. אל תשכחו לבטל את הפעולה בעזרת /noAttack.',
    no:
      'Supert! Nå er SurgeBot deaktivert. Ikke glem å slå av denne modusen med /noAttack.',
    yue:
      'SurgeBot 經已畀停用。要重新使用 Shieldy，請用 /noAttack 停用當前模式。',
    ru:
      'Отлично! Щилди отключён. Не забудьте снова включить его командой /noAttack.',
    hu:
      'Nagyszerű! A SurgeBot letiltva. ne felejtsd el kikapcsolni ezt a módot a /noAttack paranccsal.',
    fr:
      "Super! SurgeBot est maintenant désactivé. N'oubliez pas de désactiver ce mode via la commande /noAttack.",
    bg:
      'Страхотно! SurgeBot в момента е деактивиран! Не забравяйте да изключите този режим с /noAttack.',
  },
  noAttack_false: {
    en: 'Great! SurgeBot is now on.',
    es: '¡Entendido! Ahora SurgeBot está activo.',
    ca: "Molt bé, a partir d'ara en SurgeBot està actiu i vigilant aquest xat.",
    br: 'Boa! SurgeBot está ativado agora.',
    he: 'מעולה! SurgeBot דלוק כעת.',
    no: 'Supert! SurgeBot er nå aktivert.',
    ru: 'Отлично! Щилди включён.',
    yue: ' 正！Shieldy 已經開咗。',
    hu: 'Nagyszerű! a Shieldly újra engedélyezve van.',
    fr: 'Super! SurgeBot est maintenant activé!',
    bg: 'Чудесно! SurgeBot вече е включен.',
  },
  noChannelLinks_true: {
    en:
      'Great! SurgeBot will now delete messages that link to telegram channels.',
    ru:
      'Отлично! Щилди теперь будет удалять сообщения с ссылками на Телеграм-каналы.',
    es:
      '¡Genial! Ahora SurgeBot eliminará todos los mensajes que contengan enlaces a otros canales de Telegram.',
    ca:
      "D'acord, a partir d'ara en SurgeBot esborrarà tots el missatges que contenguin enllaços a altres canals de Telegram.",
    br:
      'Boa! Agora, o SurgeBot excluirá as mensagens vinculadas aos canais do telegram.',
    he: 'מעולה! מעכשיו SurgeBot ימחק הודעות עם קישור לערוץ טלגרם.',
    no:
      'Supert! SurgeBot vil nå slette meldinger som lenker til andre Telegram-kanaler.',
    yue:
      '好。由而家開始，Shieldy 會自動刪除所有連結到其它 Telegram 頻道嘅訊息。',
    hu:
      'Nagyszerű! A SurgeBot mostantól törli az összes olyan linket, ami másik telegram csatornára hivatkozik.',
    fr:
      'Super! SurgeBot va maintenant supprimer les messages qui renvoient vers des autres groupes telegram. ',
    bg:
      'Чудесно! SurgeBot  ще изтрие съобщения, които водят към Telegram групи и канали. ',
  },
  noChannelLinks_false: {
    en:
      'Great! SurgeBot will not delete messages that link to telegram channels.',
    ru:
      'Отлично! Щилди теперь не будет удалять сообщения с ссылками на Телеграм-каналы.',
    es:
      '¡Genial! Ahora SurgeBot no eliminará ningún mensaje que contenga enlaces a otros canales de Telegram.',
    ca:
      "D'acord, a partir d'ara en SurgeBot ja no esborrarà cap missatge que contengui enllaços a altres canals de Telegram.",
    br:
      'Boa! O SurgeBot não excluirá as mensagens vinculadas aos canais do telegram.',
    he: 'מעולה! SurgeBot לא ימחק הודעות עם קישור לערוצים בטלגרם.',
    no:
      'Supert! SurgeBot vil ikke slette meldinger som lenker til andre Telegram-kanaler.',
    yue: '好。Shieldy 而家唔會自動刪除所有連結到其它 Telegram 頻道嘅訊息。',
    hu:
      'Nagyszerű! A SurgeBot mostantól nem törli az olyan linket, ami másik telegram csatornára hivatkozik.',
    fr:
      "C'est noté! SurgeBot ne supprimera plus les messages qui partagerons des liens vers des groupes telegram.",
    bg:
      'Чудесно! SurgeBot няма да изтрива съобщения, които водят към Telegram групи и канали. ',
  },
  viewConfig: {
    en: 'Current config:',
  ...
  banForFastRepliesToPosts_true: {
    en:
      "Nice! SurgeBot will ban (or kick) all users who reply to your channel's posts 5 seconds after the post is created.",
    ru:
    ...
    bg:
      'Яко! SurgeBot, ще забрани (или ще "изрита") всеки потребител, които отговорят на публикациите в канала ви 5 секунди след създаването на публикацията.',
  },
  banForFastRepliesToPosts_false: {
    en:
      "Nice! SurgeBot will not ban (or kick) all users who reply to your channel's posts 5 seconds after the post is created.",
    ru:
    ...
    bg:
      'Яко! SurgeBot няма да забранява (или да "изрита") никой потребител, които отговарят на публикациите на канала ви 5 секунди след създаването на публикацията.',
  },
  banNewTelegramUsers_true: {
    en:
      'Nice! SurgeBot will ban (or kick) all newcomers with Telegram ID greater than 1 000 000 000.',
    ru:
      'Отлично! Щилди будет банить (или кикать) пользователей, у которых Телеграм ID больше 1 000 000 000.',
    bg:
      'Чудесно! SurgeBot, ще забрани (или ще "изрита") всички новодошли с идентификатор на Telegram над 1 000 000 000. ',
  },
  banNewTelegramUsers_false: {
    ...
    en:
      'Nice! SurgeBot will no ban (or kick) all newcomers with Telegram ID greater than 1 000 000 000.',
    bg:
      'Чудесно! SurgeBot няма да забранява (или да "изрита") никой новодошъл с Telegram ID над 1 000 000 000.',
  },
  surgeInfo: {
    en:
      'Surge - A modular Bitcoin Rollup-as-a-Service with a Decentralised verifier network & MPC-TSS Bridge',
    ru:
      'Surge build.',
  },
  subscription: {
  ...
  noSubscription: {
    en:
      'This is the premium version of SurgeBot. If you want to use a free version — check out @shieldy_bot. In order to use this version of the bot, you will have to purchase a subscription below. The premium version is hosted on dedicated servers that are used by only the premium users.',
    ru:
      'Это премиум версия SurgeBot. Если вы хотите использовать бесплатную версию — попробуйте @shieldy_bot. Для использования этой версии бота вам нужно приобрести подписку ниже. Премиум версия хостится на отдельных серверах, которые используются только премиум пользователями.',
  },
  subscriptionInfo: {
    en:
